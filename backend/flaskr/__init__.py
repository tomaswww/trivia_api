...
def create_app(test_config=None):
    ...
    # after completing the TODOs --> DONE
    CORS(app)
    ...
    # TEST: At this point, when you start the application you should \
    # see questions and categories generated, ten questions per page \
    ...
    # @TODO: Create a POST endpoint to get questions based \
    # on a search term. It should return any questions for \
    # whom the search term is a substring of the question. --> DONE
    # TEST: Search by any phrase. The questions list will \
    # update to include only question that include that string \
